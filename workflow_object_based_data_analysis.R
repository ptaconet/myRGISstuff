...
########################################################################################################################
########################################################################################################################
### For the hierarchical classification, uses the package HieRanFor developed by Dr Yoni Gavish. The package neither is available on a Git repository nor on the CRAN. It was downloaded from https://ars.els-cdn.com/content/image/1-s2.0-S0924271617303696-mmc5.zip and manually installed 
...
## Important note: The source PerformanceHRF and PerformanceFlatRF functions in the HieRanFor package has a bug. To fix them do the following : 
...
classification_perf_flat_vs_hie<-merge(classif_overall_stats_flat,hie.performance,by="variable")
colnames(classification_perf_flat_vs_hie)[which(colnames(classification_perf_flat_vs_hie)=="value")]="flat"
# Plot global classification indicators
classification_perf_flat_vs_hie<-melt(classification_perf_flat_vs_hie)
classification_perf_flat_vs_hie$color[classification_perf_flat_vs_hie[,2]=="flat"] <- "red"
classification_perf_flat_vs_hie$color[classification_perf_flat_vs_hie[,2]=="hier_stepwise_majority"]  <- "blue"
classification_perf_flat_vs_hie$color[classification_perf_flat_vs_hie[,2]=="hier_multiplicative_majority"]  <- "forestgreen"
...
dotchart(classification_perf_flat_vs_hie$value,labels=classification_perf_flat_vs_hie[,2],cex=1.4,pch = 21,groups= classification_perf_flat_vs_hie[,1],main=paste0("Classification performance measures by type of classification\n at level : ",column_names_lc_classes_hierarchy[i]),xlab="Measure value", col = classification_perf_flat_vs_hie$color,xlim = c(0,1)) 
dev.off()
