...
options(tinytex.verbose = TRUE)
  path_to_pic <- "/home/ptaconet/Bureau/formation_teledec/images"
```
...
**Mots clés** : télédétéction spatiale, Sentinel 2, occupation du sol, classification supervisée orientée pixel, classification supervisée orientée objet, 
...
- intégrer davantages de variables explicatives, par exemple, des textures
...
- Téléchargez la chaîne de traitement [Sen2cor (v2.5.5)](http://step.esa.int/main/third-party-plugins-2/sen2cor/sen2cor_v2-5-5/) (sous forme de fichier compressé .zip) (*attention : ne pas télécharger la dernière version v2.8 mais bien la version v2.5.5*). Notez le lien en local vers le fichier .zip pour [l'étape suivante](#configurer-logiciels). Attention : Sen2Cor est disponible sous Windows uniquement en 64 bits.
- Téléchargez l'extension [Sen2Cor Adapter](https://plugins.qgis.org/plugins/sen2cor_adapter/) de QGIS et notez le lien en local vers le fichier .zip pour l'étape suivante (sous forme de fichier compressé .zip). Notez le lien en local vers le fichier .zip pour [l'étape suivante](#configurer-logiciels).
